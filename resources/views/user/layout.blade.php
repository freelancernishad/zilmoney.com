    ...
    <aside id="sidebar" class="w-64 bg-[#0b1221] border-r border-white/5 flex-shrink-0 fixed h-full z-40 flex flex-col transform -translate-x-full md:translate-x-0 transition-transform duration-300">
        ...
        <nav class="p-4 space-y-2 flex-1 overflow-y-auto">
            ...
            <div class="pt-4 border-t border-white/5 mt-4">
                ...
                <a href="{{ route('user.plaid-test') }}" class="nav-item {{ request()->routeIs('user.plaid-test') ? 'active' : '' }} w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-white/5 text-sm font-medium transition-all">
