...
<head>
    ...
    <title>New Reply on Ticket - GoldenMark Money</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            ...
            <td align="center">
                <div class="email-container">
                    ...
                    <div class="brand-header">
                        ...
                        <div>
                            <span class="brand-badge">Support Update</span>
                        </div>
                    </div>

                    <!-- Content Body -->
                    <div class="content-body">
                        <h1 class="hero-title">New Reply on Ticket #{{ $ticket_id }}</h1>
                        <p class="hero-subtitle">
                            Hi <strong>{{ $user_name }}</strong>,<br><br>
                            A support representative has added a new reply to your ticket:
                        </p>
                        ...
                        <!-- Response Quote Card -->
                        <div class="reply-box">
                            <div class="reply-box-header">Staff Reply:</div>
                            <div class="reply-box-content">{{ $reply_content }}</div>
                        </div>

                        <p style="font-size: 13.5px; color: #64748b; line-height: 1.6; margin: 0 0 20px 0;">
                            Click the button below to view the full conversation and reply if needed.
                        </p>

                        <!-- View Ticket Action Button -->
                        <div class="btn-wrapper">
                            <a href="{{ config('app.url') }}/user/support" class="btn-primary">View &amp; Reply in Dashboard</a>
                        </div>
                    </div>
