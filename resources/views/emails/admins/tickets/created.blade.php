...
<head>
    ...
    <title>New Ticket Received - GoldenMark Money Admin</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            ...
            <td align="center">
                <div class="email-container">
                    ...
                    <div class="brand-header">
                        ...
                        <div>
                            <span class="brand-badge">Admin Support Alert</span>
                        </div>
                    </div>

                    <!-- Content Body -->
                    <div class="content-body">
                        <h1 class="hero-title">New Support Ticket</h1>
                        <p class="hero-subtitle">
                            Hello Admin,<br><br>
                            A new support ticket has been submitted by <strong>{{ $user_name }}</strong> requiring review.
                        </p>

                        <!-- Ticket Summary Card -->
                        <div class="ticket-card">
                            <div class="ticket-header">Ticket Information</div>
