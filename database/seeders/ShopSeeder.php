        ...
        $products = [
            [
                ...
                'colors' => [
                    ...
                    ['color_name' => 'Slate Charcoal', 'hex_code' => '#475569', 'bg_class' => 'bg-slate-600', 'image_url' => '/images/check-papers-preview.png'],
                ],
                'tiers' => [
            ...
            [
                ...
                'colors' => [
                    ['color_name' => 'Navy Blue', 'hex_code' => '#1e3a8a', 'bg_class' => 'bg-blue-900', 'image_url' => '/images/blank-check.jpg'],
                    ['color_name' => 'Burgundy', 'hex_code' => '#881337', 'bg_class' => 'bg-rose-900', 'image_url' => '/images/check-papers-preview.png'],
                    ['color_name' => 'Forest Green', 'hex_code' => '#14532d', 'bg_class' => 'bg-green-900', 'image_url' => '/images/white-paper-checks-preview.png'],
                ],
                'tiers' => [
            ...
            [
                ...
                'colors' => [
                    ['color_name' => 'Security Blue', 'hex_code' => '#1d4ed8', 'bg_class' => 'bg-blue-700', 'image_url' => '/images/check-papers-preview.png'],
                    ['color_name' => 'Security Green', 'hex_code' => '#047857', 'bg_class' => 'bg-emerald-700', 'image_url' => '/images/white-paper-checks-preview.png'],
                ],
                'tiers' => [
            ...
            [
                ...
                'colors' => [
                    ['color_name' => 'Security Blue/Green', 'hex_code' => '#0284c7', 'bg_class' => 'bg-sky-600', 'image_url' => '/images/white-paper-checks-preview.png'],
                    ['color_name' => 'Security Gold/Maroon', 'hex_code' => '#b45309', 'bg_class' => 'bg-amber-700', 'image_url' => '/images/check-papers-preview.png'],
                ],
                'tiers' => [
            ...
            [
                ...
                'colors' => [
                    ['color_name' => 'Prismatic Blue/Green', 'hex_code' => '#0d9488', 'bg_class' => 'bg-teal-600', 'image_url' => '/images/white-paper-checks-preview.png'],
                    ['color_name' => 'Burgundy Marble', 'hex_code' => '#9f1239', 'bg_class' => 'bg-rose-800', 'image_url' => '/images/check-papers-preview.png'],
                ],
                'tiers' => [
            ...
            [
                ...
                'colors' => [
                    ['color_name' => 'Komen Pink', 'hex_code' => '#db2777', 'bg_class' => 'bg-pink-600', 'image_url' => '/images/check-papers-preview.png'],
                ],
                'tiers' => [
            ...
            [
                ...
                'colors' => [
                    ...
                    ['color_name' => 'Burgundy Leather', 'hex_code' => '#4c0519', 'bg_class' => 'bg-rose-950', 'image_url' => '/images/blank-check.jpg'],
                ],
                'tiers' => [
